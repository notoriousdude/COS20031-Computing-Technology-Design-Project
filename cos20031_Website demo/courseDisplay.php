<?php
include_once("processCourse.php");
...
<body>
    ...
    <?php while ($row_course = mysqli_fetch_assoc($result2)) : ?>
        ...
        <div class="profile-details">
            <?php
            echo "<h2>Course ".$row_course["course_id"]."</h2>";
            ?>
            <?php
            echo "<p><strong>Course Name:</strong> ".$row_course["course_name"]."</p>";
            echo "<p><strong>Course Length:</strong> ".$row_course["course_length"]."</p>";
            echo "<p><strong>Course Price:</strong> $".$row_course["course_price"]."</p>";
            echo "<p><strong>Category:</strong> ".$row_course["category"]."</p>";
            echo "<p><strong>Enrolment Count of course:</strong> ".$row_course["enrolment_count"]." participants </p>";
            ?>
        </div>
        ...
        <div class="profile-details">
            ...
            <?php
            echo "<p><strong>About this Course:</strong></p>";
            echo "<p>".$row_course["outline_text"]."</p>";
            ?>
        </div>
        ...
        <div class="profile-details">
            ...
            <?php
            echo "<p><strong>After this course, you can:</strong></p>";
            echo "<p>".$row_course["outcome_text"]."</p>";
            ?>
        </div>
        </div> 
    <?php endwhile; ?>
