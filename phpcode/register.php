        ...
        <div class="nhan19">
            <form action="register.php" method="post">
                ...
                <div class="nhan16">
                    ...
                    <input type="text" id="degree" placeholder="Enter your degree (only 1)" name="degree" >
                </div>
                <div class="nhan16">
                    <label for="institution">Institution (optional)</label>
                    <input type="text" id="institution" placeholder="Enter your institution (only 1)" name="institution" >
                </div>
                <h2>Working Experience</h2>
                <div class="nhan16">
                    <label for="jobtitle">Job title (optional)</label>
                    <input type="text" id="jobtitle" placeholder="Enter your job title (only 1)" name="jobtitle">
                </div>
                <div class="nhan16">
                    <label for="employer">Employer (optional)</label>
                    <input type="text" id="employer" placeholder="Enter your employer (only 1)" name="employer">
                </div>
